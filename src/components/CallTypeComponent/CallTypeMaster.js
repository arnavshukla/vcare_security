...
const CallTypeMaster = ({ editEnabled, role }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            const data = await fetch(`${baseURL}/api/calltype/get`, {
                credentials: "include",
                headers: {
    ...
    const handleAddFormSubmit = (event) => {
        ...
        fetch(`${baseURL}/api/calltype/save`, {
            method: "POST",
            body: JSON.stringify({
                id: nanoid(),
                callType: addFormData.callType,
    ...
    const handleEditFormSubmit = (event) => {
        ...
        fetch(`${baseURL}/api/calltype/edit`, {
            method: "POST",
            body: JSON.stringify({
                id: editContactId,
                callType: editFormData.callType,
    ...
    const handleDeleteClick = (contactId) => {
        ...
        fetch(`${baseURL}/api/calltype/delete`, {
            method: "POST",
            body: JSON.stringify({
            ...
            if (json.responseMessage === 'Deleted CallTypeData') {
